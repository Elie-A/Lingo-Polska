...
//             </button>
//             <div className={`conjugation-collapse ${open[key] ? "open" : ""}`}>
...
//                         </button>
//                         <div className={`conjugation-collapse ${open["other"] ? "open" : ""}`}>
...
//             <h2 class="warning">
//                 ⚠️ The conjugator may return erroneous data due to the predefined
//                 <a href="https://github.com/unimorph/pol/blob/master/pol" target="_blank" rel="noopener noreferrer"> dataset
//                 </a>. We're actively working on resolving this issue. Please keep in mind that the dataset contains over 14 million records, so thorough checking is required.
//             </h2>
...
const Conjugator = () => {
    return (<div className="conjugator-container"> <div className="conjugator-card"> <div className="emoji" role="img" aria-label="Construction Barrier">
        🚧 </div>
        <h1 className="title">Conjugator Workbench</h1>
        <p className="status">Under Construction!</p>
        <p className="description"> We're crafting a powerful, interactive platform designed to help you confidently master <strong>Polish verb conjugation</strong>. Stay tuned for its release soon! </p>
        <p className="footer">
